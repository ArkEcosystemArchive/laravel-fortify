...
@section('content')
    <div class="container mx-auto">
        <div class="mx-auto my-8 md:w-3/4 lg:w-3/5 xl:w-1/2">
            <h1 class="mx-4 text-2xl font-bold md:text-4xl md:mx-8 xl:mx-16">{{ trans('fortify::auth.forgot-password.page_header') }}</h1>
                ...
                >
                    ...
                    <div class="text-right">
                        <button type="submit" class="w-full button-primary md:w-auto">
                            {{ trans('fortify::auth.forgot-password.reset_link') }}
                        </button>
                    </div>
                </form>
            </div>
