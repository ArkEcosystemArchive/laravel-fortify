...
it('will reject if the value starts with a special character', function () {
    ...
    expect($this->subject->message())->toBe(trans('fortify::validation.messages.username.special_character_start'));
});
...
it('will reject if the value ends with a special character', function () {
    ...
    expect($this->subject->message())->toBe(trans('fortify::validation.messages.username.special_character_end'));
});
...
it('will reject if the value contains consecutive special chars', function () {
    ...
    expect($this->subject->message())->toBe(trans('fortify::validation.messages.username.consecutive_special_characters'));
});
...
it('will reject if the value contains any uppercase character', function () {
    ...
    expect($this->subject->message())->toBe(trans('fortify::validation.messages.username.lowercase_only'));
});
